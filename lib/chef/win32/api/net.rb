...
#);
        #safe_attach_function :NetLocalGroupAddMembers, [:LPCWSTR, :LPCWSTR, :DWORD, :pointer, :long ], :DWORD
        safe_attach_function :NetLocalGroupAddMembers, [:pointer, :pointer, :long, :pointer, :long ], :long
